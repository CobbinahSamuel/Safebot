...
const incidentsData = [
  {
    ...
    category: "Other",
    detailedDescription: "Individual acting suspiciously near computer lab, taking photos of security systems and asking students for personal information",
  ...
  },
  {
    ...
    category: "Harassment", 
    detailedDescription: "Female student being verbally harassed and followed by group of male individuals near dormitory entrance. Incident occurred multiple times.",
  ...
  },
  {
    ...
    category: "Theft",
    detailedDescription: "Laptop and textbooks stolen from classroom during break period. Bag was left unattended for approximately 15 minutes.",
  ...
  },
  {
    ...
    detailedDescription: "Fire exit door blocked by construction materials and equipment. Emergency evacuation route is completely inaccessible.",
  ...
  },
  {
    ...
    category: "Accident",
    detailedDescription: "Student fell down stairs due to wet floor without proper warning signs or barriers. Minor injuries sustained, first aid administered.",
  ...
  },
  {
    ...
    category: "Other",
    detailedDescription: "Multiple vehicles damaged with scratches, broken mirrors, and deflated tires. Appears to be deliberate vandalism affecting 6 vehicles.",
  ...
  },
  {
    ...
    category: "Harassment",
    detailedDescription: "Repeated instances of verbal bullying and intimidation of first-year students by senior students in corridor areas.",
  ...
  },
  {
    ...
    category: "Other",
    detailedDescription: "Unknown individuals found in chemistry lab after hours without proper authorization. Lab equipment may have been tampered with.",
