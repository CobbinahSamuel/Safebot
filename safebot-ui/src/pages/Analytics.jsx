...
    
    const randomTimestamp = Date.now() - Math.floor(Math.random() * 30 * 24 * 60 * 60 * 1000) - Math.floor(Math.random() * 24 * 60 * 60 * 1000);
...
            {dashboardData.topLocationsData.slice(0, 5).map((location, index) => (
